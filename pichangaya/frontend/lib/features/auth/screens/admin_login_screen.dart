...
class _State extends State<AdminLoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // Admitir admin Y super_admin en este login
      ...
      // Guardamos el rol real (admin o super_admin)
      ...
      if (rol == 'super_admin') {
        ...
        // Super admin va a su propio dashboard
      } else {
        context.go('/admin');
        // Admin normal va al panel de admin
      }
    } catch (_) {
      setState(() {
        _error = 'Celular o contraseña incorrectos';
      });
    } finally {
      if (mounted)
        setState(() {
          ...
          child: Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  // Hints de demo — admin Y super admin
                  Container(
